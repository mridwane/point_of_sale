<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?= base_url();?>assets/images/<?= $ci->session->userdata('foto');?>" class="img-circle elevation-2"
                    alt="User Image">
            </div>
            <div class="info">
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\xampp\htdocs\point_of_sale\application\views/App/sidebar.blade.php ENDPATH**/ ?>